...
tag: [RT-Thread, 記憶體管理, Memory Heap, kernel]
...
---
<i class="fa fa-code"></i> Code: `rt_memheap_init`
...
---
## 刪除 memory heap
<i class="fa fa-code"></i> Code: `rt_memheap_detach`
...
---
<i class="fa fa-code"></i> Code: `rt_memheap_alloc`
...
---
<i class="fa fa-code"></i> Code: `rt_memheap_realloc`
...
---
<i class="fa fa-code"></i> Code: `rt_memheap_free`
