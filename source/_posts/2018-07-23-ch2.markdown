...
copyright: true
---
- <i class="fa fa-file-text-o" aria-hidden="true"></i> File: vm.c
...
---
- <i class="fa fa-code" aria-hidden="true"></i> Code: `walkpgdir`
...
## Code: 物理記憶體分配器
- <i class="fa fa-file-text-o" aria-hidden="true"></i> File: kalloc.c
...
### kinit1 / 2
- <i class="fa fa-code" aria-hidden="true"></i> Code: `kinit1`
...
---
- <i class="fa fa-code" aria-hidden="true"></i> Code: `growproc`
...
### allocuvm、deallocuvm
- <i class="fa fa-code" aria-hidden="true"></i> Code: `allocuvm`
