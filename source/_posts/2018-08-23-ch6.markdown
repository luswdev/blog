...
## 檔案描述符
- <i class="fa fa-file-text-o" aria-hidden="true"></i> File: file.c
...
- <i class="fa fa-code" aria-hidden="true"></i> Code: `filealloc`
...
---
- <i class="fa fa-code" aria-hidden="true"></i> Code: `filedup`
...
---
- <i class="fa fa-code" aria-hidden="true"></i> Code: `fileclose`
...
- <i class="fa fa-code" aria-hidden="true"></i> Code: `filestat`
...
---
- <i class="fa fa-code" aria-hidden="true"></i> Code: `stati`
...
---
- <i class="fa fa-code" aria-hidden="true"></i> Code: `fileread`
...
---
- <i class="fa fa-code" aria-hidden="true"></i> Code: `filewrite`
...
## Code: Path names
- <i class="fa fa-file-text-o" aria-hidden="true"></i> File: fs.c

### namex
- <i class="fa fa-code" aria-hidden="true"></i> Code: `namex`
