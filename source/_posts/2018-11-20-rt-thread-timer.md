...
### 靜態記憶體管理
<i class="fa fa-code"></i> Code: `rt_timer_init`
...
---
### 動態記憶體管理
<i class="fa fa-code"></i> Code: `rt_timer_create`
...
## 刪除 timer
### 動態記憶體管理
<i class="fa fa-code"></i> Code: `rt_timer_delete`
...
---
### 靜態記憶體管理
<i class="fa fa-code"></i> Code: `rt_timer_detach`
...
<i class="fa fa-code"></i> Code: `rt_timer_check`
