...
---
## 初始化 scheduler
<i class="fa fa-code"></i> Code: `rt_system_scheduler_init`
...
<i class="fa fa-code"></i> Code: `rt_system_scheduler_start`
...
<i class="fa fa-code"></i> Code: `rt_schedule`
...
---
## 插入 thread
<i class="fa fa-code"></i> Code: `rt_schedule_insert_thread`
...
---
## 移除 thread
<i class="fa fa-code"></i> Code: `rt_schedule_remove_thread`
