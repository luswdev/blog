...
tag: [RT-Thread, 記憶體管理, Memory Pool, kernel]
...
### 動態
<i class="fa fa-code"></i> Code: `rt_mp_create`
...
<i class="fa fa-code"></i> Code: `rt_mp_init`
...
## 刪除 memory pool
### 動態
<i class="fa fa-code"></i> Code: `rt_mp_delete`
...
---
### 靜態
<i class="fa fa-code"></i> Code: `rt_mp_detach`
