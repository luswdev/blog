...
- <i class="fa fa-file-text-o" aria-hidden="true"></i> File: entry.s
...
- <i id="userinit" class="fa fa-code" aria-hidden="true"></i> Code: `userinitㄒ`
...
- <i class="fa fa-code" aria-hidden="true"></i> Code: `mpmain`
...
---
- <i class="fa fa-code" aria-hidden="true"></i> Code: `forkret`
