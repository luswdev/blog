...
comments: true
categories: xv6
tag: [xv6, schedluler, context switch, sleep, wakeup, kill, wait, exit, c, asm, kernel]
copyright: true
description: 解釋 xv6 context switch 的流程，及睡眠與喚醒之介紹。
images: https://i.imgur.com/8VEzDwI.png
---
## Multiplexing
