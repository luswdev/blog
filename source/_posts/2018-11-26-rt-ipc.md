...
tag: [RT-Thread, kernel, semaphore]
...
---
### 進入 scheuler 鎖
<i class="fa fa-code"></i> Code: `rt_enter_critical `
...
---
### 離開 scheduler 鎖
<i class="fa fa-code"></i> Code: `rt_exit_critical `
...
---
<i class="fa fa-code"></i> Code: `rt_critical_level `
...
### 建立 semaphore
#### 動態記憶體管理
<i class="fa fa-code"></i> Code: `rt_sem_create`
...
---
#### 靜態記憶體管理
<i class="fa fa-code"></i> Code: `rt_sem_init`
...
### 刪除 semaphore
#### 動態記憶體管理
<i class="fa fa-code"></i> Code: `rt_sem_delete`
...
---
#### 靜態記憶體管理
<i class="fa fa-code"></i> Code: `rt_sem_detach`
...
<i class="fa fa-code"></i> Code: `rt_sem_take`
...
<i class="fa fa-code"></i> Code: `rt_sem_trytake`
...
<i class="fa fa-code"></i> Code: `rt_sem_release`
...
### 建立 mutex
#### 動態記憶體管理
<i class="fa fa-code"></i> Code: `rt_mutex_create`
...
---
#### 靜態記憶體管理
<i class="fa fa-code"></i> Code: `rt_mutex_init`
...
### 刪除 mutex
#### 動態記憶體管理
<i class="fa fa-code"></i> Code: `rt_mutex_delete`
...
---
#### 靜態記憶體管理
<i class="fa fa-code"></i> Code: `rt_mutex_detach`
...
<i class="fa fa-code"></i> Code: `rt_mutex_take`
...
<i class="fa fa-code"></i> Code: `rt_mutex_release`
...
### 建立事件
#### 動態記憶體管理
<i class="fa fa-code"></i> Code: `rt_event_create`
...
---
#### 靜態記憶體管理
<i class="fa fa-code"></i> Code: `rt_event_init`
...
---
#### 靜態記憶體管理
<i class="fa fa-code"></i> Code: `rt_event_detach`
...
---
### 傳遞事件
<i class="fa fa-code"></i> Code: `rt_event_send`
...
---
### 接收事件
<i class="fa fa-code"></i> Code: `rt_event_recv`
